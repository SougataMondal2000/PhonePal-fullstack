...
const Hero = () => {
  return (
    ...
    >
      <div className="">
        <h1 className="lg:text-7xl text-5xl text-transparent bg-clip-text bg-gradient-to-r from-black to-gray-500 lg:font-semibold">
          PHONEPAL,
          <br />
          THE GREATEST
          <br />
      ...
      <div className="h-fit w-[500px] shadow-2xl rounded-lg justify-center items-center overflow-hidden">
